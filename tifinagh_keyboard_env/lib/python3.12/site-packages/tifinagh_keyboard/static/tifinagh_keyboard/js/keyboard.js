document.addEventListener("DOMContentLoaded", function () {
  ...
  const row1 = ["ⴰ","ⴱ","ⴲ","ⴳ","ⴴ","ⴵ","ⴶ","ⴷ","ⴸ","ⴹ","ⴺ","ⴻ","ⴼ","ⴽ","ⴾ","ⴿ","ⵀ","ⵁ"];
  const row2 = ["ⵂ","ⵃ","ⵄ","ⵅ","ⵆ","ⵇ","ⵈ","ⵉ","ⵊ","ⵋ","ⵌ","ⵍ","ⵎ","ⵏ","ⵐ","ⵑ","ⵒ","ⵓ"];
  const row3 = ["ⵔ","ⵕ","ⵖ","ⵗ","ⵘ","ⵙ","ⵚ","ⵛ","ⵜ","ⵝ","ⵞ","ⵟ", "\u2D60", "\u2D61", "\u2D62", "\u2D63", "\u2D64", "\u2D65"];
  const row4 = [
     "\u2D66", "\u2D67",
     "\u2D6F","\u2D70",, "\u2D7F",".", ",", "?", "!", "(", ")", "*", "%", "#", "@", "$"
  ];
 ...
 */
 ...
 // const symbolsRow = [];
  ...
  container.appendChild(createRow(row0, true));
