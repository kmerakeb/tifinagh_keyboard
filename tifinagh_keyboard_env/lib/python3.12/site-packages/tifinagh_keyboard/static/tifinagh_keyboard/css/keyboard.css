...
.key.wide {
  flex: 2; /* double the space of a regular key */
}
...
.key-delete {
  flex: 3; /* Makes it take the space of 3 regular keys */
  background-color: #e74c3c; /* Optional: make it stand out */
  color: white;
  font-weight: bold;
}
...
.tifinagh-virtual-keys {
  font-family: 'Noto Sans Tifinagh', sans-serif;
}

.tifinagh-virtual-keys button {
  margin: 2px;
  font-size: 20px;
  padding: 5px;
}
